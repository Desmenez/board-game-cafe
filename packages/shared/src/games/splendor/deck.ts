import type { SplendorGem, SplendorGems } from './types.js';
  ...
  return [
    {
      ...
      name: 'Mary Stuart',
      prestige: 3,
      requires: { ...z(), black: 3, blue: 3, white: 3 },
    },
    {
      id: 'noble-2',
      artKey: '2',
    ...
    },
    {
      ...
      prestige: 3,
      requires: { ...z(), green: 3, black: 3, red: 3 },
    },
    {
      id: 'noble-4',
      artKey: '4',
      name: 'Charles V',
      prestige: 3,
      requires: { ...z(), green: 3, blue: 3, red: 3 },
    },
    {
      id: 'noble-5',
      artKey: '5',
      name: 'Henry VIII',
      prestige: 3,
      requires: { ...z(), black: 3, white: 3, red: 3 },
    },
    {
      id: 'noble-6',
      artKey: '6',
    ...
    },
    {
      ...
      prestige: 3,
      requires: { ...z(), green: 3, blue: 3, white: 3 },
    },
    {
      id: 'noble-10',
      artKey: '10',
