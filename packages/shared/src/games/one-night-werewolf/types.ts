...
const ONUW_ROLES_COMPOSITION_PASSIVE: ReadonlySet<OnuwRole> = new Set([
  'villager',
  'hunter',
  'tanner',
]);
...
export const ONUW_ROLE_DESCRIPTION_TH: Record<OnuwRole, string> = {
  ...
  mason: 'ฝ่ายชาวบ้าน — กลางคืนรู้ว่าใครเป็น Mason ด้วยกัน (ถ้ามีมากกว่าหนึ่งคน)',
  seer: 'ฝ่ายชาวบ้าน — ดูการ์ดของผู้เล่นหนึ่งคน หรือดูการ์ดกลางสองใบ (ไม่รวมการ์ดของคุณเอง)',
  robber:
    'ฝ่ายชาวบ้าน — สลับการ์ดของคุณกับผู้เล่นอื่นหนึ่งคนโดยไม่ดูการ์ดของเขาก่อน — จากนั้นคุณจะได้บทบาทใหม่ของเขา',
  troublemaker: 'ฝ่ายชาวบ้าน — สลับการ์ดของผู้เล่นอื่นสองคน (ไม่รวมคุณ)',
  drunk:
  ...
  tanner: 'เล่นคนเดียว — คุณชนะถ้าคุณถูกโหวตออกเท่านั้น',
