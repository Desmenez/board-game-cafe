...
8. **Friend codes (`profiles.handle`):** Immutable 6-character codes using full
   A–Z / 0–9 (`ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789`, including I/O/0/1),
   assigned at signup. Not editable by clients (DB trigger). Display name and
   avatar remain editable. Room codes keep the ambiguous-safe alphabet.
